...
function HomeView({ data, storageError, setView, menuOpen, setMenuOpen, exportData, importData }) {
  ...
  return h(Fragment, null,
    h("header", { className: "brand-app-head" },
      h("div", { className: "brand-app-lockup" },
        h("img", { className: "brand-app-icon", src: "rootwork-mark.svg?v=4.4.0", alt: "" }),
        h("div", { className: "brand-app-copy" },
          h("div", { className: "brand-app-wordmark" }, "ROOT", h("span", null, "WORK")),
    ...
    h("div", { className: "home-context" },
      h("span", null, formatToday()),
      h("strong", null, percent + "% hôm nay")),
